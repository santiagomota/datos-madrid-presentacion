...
- Implementación: Se aportan varios ejemplos en el repositorio [Link](https://github.com/santiagomota/madrid-open-data-mejora) y el repositorio [Link](https://github.com/santiagomota/datos-madrid). El primero son ejemplos relativamente sencillos y en el segundo se abordan problemas de mas profundidad, en el especial el del tráfico de Madrid, tanto histórico como en tiempo real.
