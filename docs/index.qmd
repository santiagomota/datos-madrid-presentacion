...
format: 
  ...
  beamer: 
    ...
    logo: figs/logo_premios_3.png
    header-includes: |
      \titlegraphic{\includegraphics[width=0.2\paperwidth]{figs/logo_premios_2.png}}
      \setbeamertemplate{footline}[page number]
    footline: "Premios a la reutilización 2025 - https://mejoras-madrid.netlify.app/"
title-slide-attributes:
  data-background-image: ./figs/Leaflet_trafico.png
...
- Abrir una página de [Github](https://github.com/).
- Incorporar datos en [Kaggle](https://www.kaggle.com) (crear un usuario para el ayuntamiento).
...
- Implementación: Se aportan varios ejemplos en el repositorio [Link](https://github.com/santiagomota/madrid-open-data-mejora) y el repositorio [Link](https://github.com/santiagomota/datos-madrid). El primero son ejemplos relativamente sencillos y en el segundo se abordan problemas de mas profundidad, en el especial el del tráfico de Madrid.

![](./figs/Leaflet_trafico.png){fig-align="center"}
...
## Exportar datos a parquet y usar duckDB II
...
- Vídeo presentación (7 minutos) [Youtube](https://youtu.be/Vt4EKwCKC7Q) [Repositorio](../varios/Video_largo.mkv)
- Vídeo presentación (< 3 minutos) [Youtube](https://youtu.be/A3MUcfs1YbU) [Repositorio](../varios/Video_corto.mkv)
